...
export const tl: Translation = {
  ...
  patientDetail: {
    ...
    viewReferralDoc: 'Dokumento ng referral',
    noShowChip: 'No-show',
  ...
  referralDoc: {
    ...
    optionalNote:
      'Naipadala na ang referral na ito sa pasilidad ng TB-DOTS. Opsyonal ang pag-print — bigyan lamang ng kopya ang pasyente kung makatutulong ito sa kanya.',
    ...
    vitalsSection: 'Mga vital sign (ayon sa sinukat)',
    vitalsNote:
      'Mga sukat lamang, itinala para sa pasilidad. Hindi nito binabago ang rekomendasyon sa referral.',
    referralSection: 'Referral',
    facility: 'Tumatanggap na pasilidad',
    appointment: 'Appointment para sa check-up',
    sputumNote: 'Sa pasilidad ng TB-DOTS ginagawa ang pagkuha at pagsusuri ng plema.',
  ...
  vitals: {
    ...
    intro:
      'Itala ang anumang nasukat mo. Maaaring iwang blangko ang alinmang patlang, at hindi naaapektuhan ang referral kung laktawan ang hakbang na ito.',
    ...
    bmi: 'BMI',
    bmiDerived: 'BMI, mula sa taas at timbang',
    ...
    unitPercent: '%',
    unitBmi: 'kg/m²',
    outOfRange: 'Suriin ang sukat na may pulang marka — mukhang mali ang pagkaka-type.',
    fixBeforeContinuing: 'Ayusin ang sukat na may pulang marka',
    skipCta: 'Laktawan — walang nasukat',
  },
  screening: {
