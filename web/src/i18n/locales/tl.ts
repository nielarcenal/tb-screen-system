...
export const tl: Translation = {
  ...
  cases: {
    ...
    timeline: {
      ...
      privacy: 'Totoong kasaysayan mula sa mga rekord na nakikita ng pasilidad na ito. Hindi kasama ang clinical free text, contact details, at pinawalang-bisang pagbisita.',
